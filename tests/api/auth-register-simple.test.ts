...
/**
 * Tests for the simple register API endpoint
 * POST /api/auth/register-simple
 * 
 * Tests simplified registration without rate limiting
 */

describe('Authentication Register Simple API', () => {
  const testUser = {
  ...
  describe('POST /api/auth/register-simple', () => {
    it('should register a new user successfully', async () => {
      const request = new NextRequest('http://localhost:3000/api/auth/register-simple', {
        method: 'POST',
        headers: {
    ...
    it('should reject duplicate email registration', async () => {
      // First registration
      const request1 = new NextRequest('http://localhost:3000/api/auth/register-simple', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      const request2 = new NextRequest('http://localhost:3000/api/auth/register-simple', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
    ...
    it('should handle unknown errors gracefully', async () => {
      ...
      vi.spyOn(prisma.user, 'findUnique').mockRejectedValueOnce('Unknown error')
