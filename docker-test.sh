...
# Docker Test Script for Authentication System
# This script sets up and runs tests in Docker
...
for i in {1..60}; do
    if docker compose logs mongodb 2>/dev/null | grep -q "Waiting for connections"; then
